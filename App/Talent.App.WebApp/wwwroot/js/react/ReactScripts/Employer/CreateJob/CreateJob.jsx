...
export default class CreateJob extends React.Component {
    ...
    loadData() {
        console.log(Cookies.get('editId'));
        //alert(Cookies.get('editId'));
        //const root = "" 
       ...
       // var param = this.props.match.params.id ? this.props.match.params.id : "";//workaround till we get Redux in to keep the page from breaking
        var param = Cookies.get('editId');// used cookies instead of router 
        var copyJobParam = Cookies.get('copyId');;
     // var copyJobParam = this.props.match.params.copyId ? this.props.match.params.copyId : "";
       
        if (param != "" || copyJobParam != "") {
            if (param != "") {
                this.setState({ heading: "Update Job" });
                Cookies.set('editId', ""); 
            }
            if (copyJobParam != "") {
                this.setState({ heading: "Create Job" });
                Cookies.set('copyId', "");
            }
